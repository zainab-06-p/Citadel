...
async function simulatePayout({
  ...
  try {
    ...
    // Try creating a real Razorpay order; if unavailable, keep fully simulated mode.
    try {
      ...
      console.warn('[Payout Simulation] Razorpay order creation unavailable, using local simulation:', orderError.message);
    }
