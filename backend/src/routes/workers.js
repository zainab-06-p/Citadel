 ...
 * Get all milestone payout states for a worker — with full receipt data
 */
router.get('/:address/payment-history', async (req, res) => {
  try {
    ...
    // Paid milestones first by paidAt desc; unpaid milestones later by app/milestone index.
    payments.sort((a, b) => {
      ...
      if (a.appId !== b.appId) return b.appId - a.appId;
