...
import { Briefcase, ClipboardCheck, UserCircle, Landmark, Shield, ArrowRight, Wallet, ChevronDown, Banknote } from 'lucide-react'
import citadelLogo from './assets/citadel-logo.png'

type ViewType = 'contractor' | 'supervisor' | 'worker' | 'bank' | 'consent'
